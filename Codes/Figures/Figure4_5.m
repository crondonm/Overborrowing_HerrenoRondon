...
load("IICECC.mat") ; % load imperfect info CE solution
save("IICEsim.mat",'-struct','IICECC', '-v7.3') ;
clear IICECC
load('IICEsim.mat')
...
load("IIPCC_test.mat") ; % load imperfect info CE solution
save("IIPCCsim.mat",'-struct','IIPCC', '-v7.3') ;
clear IIPCC
load('IIPCCsim.mat')
...
load("FICE.mat") ; % load imperfect info CE solution
save("FICEsim.mat",'-struct','FICE', '-v7.3') ;
clear FICE
load('FICEsim.mat')
...
load("FIP_test.mat") ; % load imperfect info CE solution
save("FIPsim.mat",'-struct','FIP', '-v7.3') ;
clear FIP
load('FIPsim.mat')
...
saveas(f4,'Figures/Figure4_bb_drivers','png');
...
saveas(f5, 'Figures/Figure5_responses_crises', 'png');
